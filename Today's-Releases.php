...
$today = date("Y-m-d");
$result = mysqli_query($conn,"SELECT * FROM prisoners WHERE exit_date <= '$today'");
...
";
        ...
        echo "No Prisoners are to be relesed today";
    }
}

}
else{
    echo "No prisoners are to be released today..";
}
?>
</div>
</body>
